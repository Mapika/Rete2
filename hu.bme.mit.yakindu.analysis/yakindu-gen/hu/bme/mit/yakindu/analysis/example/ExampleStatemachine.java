...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_Csapda:
				main_region_Csapda_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Csapda:
			return stateVector[0] == State.main_region_Csapda;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state Csapda */
	private void enterSequence_main_region_Csapda_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Csapda;
	}
	...
	/* Default exit sequence for state Csapda */
	private void exitSequence_main_region_Csapda() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_Csapda:
			exitSequence_main_region_Csapda();
			break;
		default:
			break;
		}
			...
			if (react()==false) {
				if (sCInterface.black) {
					...
					if (timeEvents[0]) {
						...
						if (sCInterface.trap) {
							exitSequence_main_region_Black();
							enterSequence_main_region_Csapda_default();
						} else {
							did_transition = false;
						}
					}
	...
	private boolean main_region_Csapda_react(boolean try_transition) {
		boolean did_transition = try_transition;
